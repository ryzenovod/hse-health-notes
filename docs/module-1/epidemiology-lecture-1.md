...
На лекции это разбирали на простых несоответствиях. Лекарство могут изучать полгода, а затем назначать пожизненно. Кава-фильтры приводились как пример практики, показания к которой пересматривали после появления новых данных. Даже устройство системы здравоохранения остаётся предметом спора: по словам лектора, у бюджетно-страховой модели, действующей с 1993 года, до сих пор нет одной общепринятой оценки.
...
[![Точечная диаграмма с отрицательной связью между условным потреблением шоколада и баллом по шкале депрессии; справа показаны два возможных направления причинности](../assets/correlation-causality.png)](../assets/correlation-causality.png)
...
Лектор разобрал исследование мужчин старше 50 лет после среднего или тяжёлого инфаркта. Все участники курили и согласились бросить. Одной группе три года раз в неделю помогала медсестра, контрольная группа получила памятку о вреде курения. Основным исходом была смерть от любых причин.
...
[![Два схематических линейных графика: вмешательство улучшает отказ от курения, но на втором графике у той же группы выше накопленная смертность](../assets/abstract-vs-tables.png)](../assets/abstract-vs-tables.png)
...
По словам лектора, плановые показатели и подушевое финансирование могут подталкивать поликлиники к фиктивным записям о диспансеризации. Это пример того, как способ оплаты меняет не только работу организации, но и данные, по которым её оценивают.
