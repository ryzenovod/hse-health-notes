...
В базовой модели два кандидата выбирают позиции на одной политической шкале и стремятся победить на выборах. Они знают предпочтения избирателей; те голосуют за более близкую позицию, а их предпочтения одновершинны. У обоих кандидатов появляется стимул приблизиться к позиции медианного избирателя. Если оба выбрали её, модель не обещает победу одному из них: при совпадающих программах нужно правило разрешения ничьей. [Модель пространственной конкуренции и её предпосылки](https://www.sas.rochester.edu/psc/duggan/papers/polling110507.pdf).
...
В файле [«EOS — теории, графики и прочее»](../materials/eos/theory-and-graphs.docx) приведены два результата о расходах на получение привилегии. **Рассеяние ренты** означает, что борьба за выигрыш расходует ресурсы, не создавая в рамках модели нового продукта.

При **полном рассеянии** суммарные ожидаемые расходы равны ценности приза `R`. Такой результат получается, например, в симметричной модели двух нейтральных к риску участников, где приз получает потративший больше, но свои расходы несут оба. Равенство относится к ожидаемым расходам в равновесии, а не к любой отдельной попытке лоббирования. [Модель конкурса с оплатой расходов всеми участниками](https://www.uoguelph.ca/economics/sites/uoguelph.ca.economics/files/public/documents/2010-12.pdf).
